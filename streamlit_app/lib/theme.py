...
/* Hide only Streamlit chrome widgets — never hide app link_buttons
   (Google login OAuth URLs contain redirect_to=*.streamlit.app). */
...
def render_grouped_asset_nav(
    *,
    ...
    if cur in legacy:
        ...
        elif cur in ("관심", "부채", "세금", "순자산", "기타자산", "예적금"):
